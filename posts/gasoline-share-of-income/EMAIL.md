# Mailchimp teaser: We still measure inflation with a tape deck
...
`images/gasoline-share-of-income-hero-1680x1080.png`, linked to the post. Email export: `images/gasoline-share-of-income-hero-email.jpg` (275 KB).
Alt:
```
...
We still measure inflation with a tape deck
...
You are one of those people. So, let's start here. Does CPI capture the impact of gasoline inflation on your life? If not, is there a way to fix it? Click the button below and find out.
```

## 7. Call to action

**[Read our latest research](https://www.data4thepeople.com/p/gasoline-share-of-income)**
